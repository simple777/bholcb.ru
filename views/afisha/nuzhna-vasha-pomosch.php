...
<head>
    ...
    <link rel="stylesheet" href="<?php echo SITEURL;?>css/afisha.css">
                ...
                <div class="afisha">
                    ...
                    <div class="p-big-text">
                        <h2>Уважаемые пользователи!</h2>
                            ...
                            <p>Просим Вас оказать помощь в
                            сборе денежных средств для
                            участия в ППМИ-2018 года по
                            ремонту помещения <span class="border-dashed">абонемента</span>
                            и <span class="border-dashed">второго этажа</span> центральной
                            библиотеки</p>
