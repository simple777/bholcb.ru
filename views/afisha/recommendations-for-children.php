        ...
        <main role="main" class="content">
            ...
            <div class="projects-wrapper">
                <div class="projects">
                    ...
                    <h2>Детская библиотека рекомендует</h2>
                    ...
                    <div class="content-line-wrapper-2">
                            ...
                            <div class="content-line-block-content">
                                <div class="content-line-block-content-in">
                                    <div class="content-line-block-content-in-text">
                                        <h2 class="content-line-block-header">Для подростков и их родителей</h2>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="content-line-block-2">
                            <div class="content-line-block-content">
                                <div class="content-line-block-content-in">
                                    <div class="content-line-block-content-in-text">
                                        <h2 class="content-line-block-header">Кошке посвящается</h2>
                                    </div>
                                </div>
                            </div>
